...
unshift : add the element to the first 
...
**Ma réponse :**
`.pop()` : remove last element from thge Array
...
**Ma réponse :**
déterminer le nombre d'élements dans un Array
...
**Ma réponse :**
utilisant la methode Array.isArray(arr)
expl:
